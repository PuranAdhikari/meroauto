<div id="car-model-search-form" {!! isset($searching) ? '' : 'hidden' !!}>
    {!! Form::open(['url'=>'/admin/car-models/search', 'method'=>'GET']) !!}
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                {!! Form::select('manufacturer', selectManufacturers(), null, ['class'=>'form-control input-sm', 'placeholder'=>'--Select Manufacturer--']) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                <a href="/admin/car-models" class="btn btn-warning btn-sm btn-block"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Reset
                    Filter</a>
            </div>
        </div>
    </div>
