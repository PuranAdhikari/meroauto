<div id="car-variant-search-form" {!! isset($searching) ? '' : 'hidden' !!}>
    {!! Form::open(['url'=>'/admin/car-variants/search', 'method'=>'GET']) !!}
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                {!! Form::select('model', selectCarModels(), null, ['class'=>'form-control input-sm', 'placeholder'=>'--Select Model--']) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                <a href="/admin/car-variants" class="btn btn-warning btn-sm btn-block"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Reset
                    Filter</a>
            </div>
        </div>
    </div>
