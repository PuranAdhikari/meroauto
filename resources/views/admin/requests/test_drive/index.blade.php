...
@section('content')
    ...
    @push('breadcrumb')
    <li class="active">
        <strong>Test Drive Requests</strong>
    </li>
    @endpush
    @include('admin.layouts.partials.breadcrumb', ['title'=>'Test Drive Requests List'])
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            ...
                            @if(count($requests))
                                {!! Form::open(['url'=>'admin/requests/test-drive/delete', 'id'=>'delete-form']) !!}
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="project-title">Preferred Day / Time</th>
                                        <th class="project-title">Preferred Contact</th>
                                        <th class="project-title">Requested Date</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($requests as $key => $request)
                                        <tr>
                                            ...
                                            <td>
                                                {!! $request->preferred_day !!} / {!! $request->preferred_time !!}
                                            </td>
                                            <td>
                                ...
                                {!! Form::close() !!}
                            @else
                                <p>No test drive requests to show.</p>
                            @endif
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        $('#delete-selected').click(function (e) {
            ...
            if (ck_box > 1) {
                if (confirm('WARNING: You are about to trash the selected test drive requests!'))
                    $('#delete-form').submit();
            }
            else {
