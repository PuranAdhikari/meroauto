     ...
     <div class="container"> 
      <div class="row"> 
       <div class="col-lg-12 col-md-12"> 
        ...
        <ul class="menu-logo">
            <li>
                <a href="index.html"><img id="logo_dark_img" src="{{ URL::asset('template/images/MeroAutoLogo.png') }}" alt="logo"> </a>
            </li>
        </ul>
        <!-- menu links -->
        <ul class="menu-links">
...
<section class="blog blog-single page-section-ptb" style="margin-top: -2.1em;">
  <div class="container">
    <div class="row">
        ...
        <div class="blog-entry">
          ...
          <div class="entry-meta">
            <ul>
              ...
              <li><a href="{{ 'englishnews' }}"><i class="fa fa-newspaper-o"></i>Read in English</a></li>
          ...
          <div class="entry-content">
            ...
            Nec sagittis sem lorem ipsum dolor sit amet  of Lorem Ipsum. Proin graelit consequat ipsum, nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt pharetra.</p>
            ...
            Sagittis sem nibh lorem ipsum dolor sit amet  of Lorem Ipsum. Proin graelit consequat ipsum, nec id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt pharetra.</p>
         </div> 
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="navigation-next">
                <a href="#"> 
                  <img class="img-responsive" src="{{ URL::asset('template/images/bg/01.jpg') }}" alt="">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="navigation-previous pull-right text-right">
                <a href="#"> 
                  <img class="img-responsive" src="{{ URL::asset('template/images/bg/06.jpg') }}" alt="">
                  <div class="port-arrow">
