                                    ...
                                    <ul class="drop-down-multilevel">
                                        <li class="active"><a href="javascript:void(0)">blog classic <i
                                            ...
                                            <ul class="drop-down-multilevel">
                                                ...
                                                <li class="active"><a href="blog-right-sidebar.blade.php">right
                                                        sidebar</a></li>
                    ...
                    <div class="blog-entry">
                        <div class="blog-entry-image  clearfix">
                            <div class="portfolio-item">
                                <img class="img-responsive" src="{{ URL::asset('uploadedimages/') }}" alt="">
                            </div>
                        </div>
                        <div class="entry-title">
                            @if( $news_single->language_typ == 'both')
                                <a href="">{{ $news_single->headline_en . $news_single->headline_np }}</a>
                            @elseif( $news_single->language_typ == 'np')
                                <a href="">{{ $news_single->headline_np }}</a>
                            @else
                                <a href="">{{ $news_single->content_en }}</a>
                            @endif
                        </div>
                        <div class="entry-meta">
                            <ul>
                                <li><a href="#"><i class="fa fa-user"></i> By {{ $news_single->author }} </a> /</li>
                                <li><a href="#"><i class="fa fa-comments-o"></i> 5 Comments</a> /</li>
                                <li><a href="#"><i class="fa fa-folder-open"></i> News {{ $news_single->created_at }}
                                    </a> /
                                </li>
                        ...
                        <div class="entry-content">
                            @if($news_single->language_typ == 'both')
                                <a href="">{{ $news_single->content_en . "<br/>" . $news_single->content_np }}</a>
                            @elseif( $news_single->language_typ == 'np')
                                <a href="">{{ $news_single->content_np }}</a>
                            @else
                                <a href="">{{ $news_single->content_en }}</a>
                            @endif
                        </div>
                        <div class="entry-share clearfix">
                            <a class="button red pull-left" href="/englishnews/{{ $news_single->id }}"> Read More </a>
