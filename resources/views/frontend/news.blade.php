                ...
                <div class="blog-entry">
                    <div class="blog-entry-image  clearfix">
                        <div class="portfolio-item">
                            <img class="img-responsive" src="{{ URL::asset('uploadedimages/'.$content->image->name) }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="entry-meta">
                        <ul>
                            ...
                            @foreach ($filterLanguage as $lang )
                                @if ($lang != null)
                            <li><a href="{{ '/englishnews/'.$content->id }}"><i class="fa fa-newspaper-o"></i>Read in English</a></li>
@endif
                                @endforeach
