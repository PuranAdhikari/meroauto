                ...
                <div class="col-lg-6 col-md-6">
                    <div class="topbar-left text-left">
                        <ul class="list-inline">
                            <li><i class="fa fa-envelope-o"> </i> info@meroauto.com</li>
                            ...
                            <ul class="menu-logo">
                                <li>
                                    <a href="index.html"><img id="logo_img"
                                                              src="{{ URL::asset('template/images/logo-light.png') }}"
                                                              alt="logo"> </a>
                                </li>
                            </ul>
                            <!-- menu links -->
                                ...
                                <li class="active"><a href="javascript:void(0)">blog <i
                                    ...
                                    <ul class="drop-down-multilevel">
                                        <li class="active"><a href="javascript:void(0)">blog classic <i
                                            ...
                                            <ul class="drop-down-multilevel">
                                                <li class="active"><a href="blog-left-sidebar.blade.php">left
                                                        sidebar</a></li>
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="recent-post">
                        <div class="recent-post-image">
                            <img src="{{ URL::asset('template/images/car/01.jpg') }}" alt="">
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="recent-post-image">
                            {{--<img src="{{ URL::asset('template/images/car/02.jpg') }}" alt="">--}}
                    ...
                    <div class="recent-post">
                        <div class="recent-post-image">
                            <img src="{{ URL::asset('template/images/car/03.jpg') }}" alt="">
                        </div>
                        <div class="recent-post-info">
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="widget-link">
                        <ul>
                            ...
                            <li><a href="#"> <i class="fa fa-angle-right"></i> March <span class="pull-right">08</span></a>
                            </li>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="blog-entry">
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="{{ URL::asset('template/images/1.png') }}" alt="Los Angeles"
                                         style="width:100%; height: 400px;">
                                </div>

                                <div class="item">
                                    <img src="{{ URL::asset('template/images/2.png') }}" alt="Chicago"
                                         style="width:100%; height: 400px;">
                                </div>

                                <div class="item">
                                    <img src="{{ URL::asset('template/images/3.png') }}" alt="New york"
                                         style="width:100%; height: 400px;">
                                </div>
                            </div>
                ...
                <div class="entry-content">
                    <p>You will begin to realize why this exercise is called the Dickens Pattern with reference to the
                        ghost showing Scrooge some different futures as you notice that the idea of this exercise is to
                        hypnotize yourself to be aware of two very real possibilities for your future. Two distinct
                        pathways that you could take for your life this very day. Have a think about something that you
                        do that you are maybe not motivated.</p>
                </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="about-content">
                    <img class="img-responsive" id="logo-footer"
                         src="{{ URL::asset('template/images/logo-light.png') }}" alt="">
